...
internal static class WGPUConv {
	//public static WGPUX ToWebGPUType(this X v) => (WGPUX)v;
	//public static X FromWebGPUType(this WGPUX v) => (X)v;
	...
	public static TextureAspect FromWebGPUType(this WGPUTextureAspect v) => (TextureAspect)v;
	public static TextureFormat FromWebGPUType(this WGPUTextureFormat v) => (TextureFormat)v;
	public static TextureUsage FromWebGPUType(this WGPUTextureUsage v) => (TextureUsage)(ulong)v;
	public static TextureViewDimension FromWebGPUType(this WGPUTextureViewDimension v) => (TextureViewDimension)v;
}
